export const Hero: React.FC = () => {
  return (
    <div className="h-[calc(100vh-128px)] bg-red-500 bg-center bg-cover bg-[linear-gradient(to_right,rgba(0,0,0,0.6),rgba(255,255,255,0.2)),url(/background.jpeg)] rounded-2xl mx-6 my-8 relative flex flex-col gap-y-8 justify-center px-8 sm:px-16 items-start">
